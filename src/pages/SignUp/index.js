     ...
     <div className='flex items-center justify-center py-10'>
            <div className='w-1/2 bg-white  rounded-xl flex flex-col items-center py-10'>
                ...
                <div className='flex flex-col w-3/5 py-4 space-y-4 items-center'>
                    ...
                    <input  className='w-full rounded-full py-2 border px-8' placeholder='Name'/>
                    ...
                    <div className='flex flex-col items-center w-full space-y-3'>
                        <button className='w-full py-2 text-white rounded-full ' style={{background:"#7536C6"}}>Create now</button>
                        <h5 className='flex items-center '>
                             <span className="" style={{color: "#2D333A"}}>Have an account?</span>
                              <span className='' style={{color:"#7536C6"}}>Login</span>
                        </h5>
